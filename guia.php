...
?>
  ...
  <div class="container py-5">
    ...
    <div class="row g-4 mb-5 justify-content-center">
      ...
      <div class="col-6 col-md-3">
        <div class="guia-card text-center">
          ...
          <p style="font-size:12px;color:var(--texto-suave);margin:0;">pessoas</p>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="guia-card">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;flex-wrap:wrap;gap:8px;">
            ...
            <div>
              <span style="font-size:1.3rem;font-weight:700;color:var(--destaque-texto);">R$ 90,00/kg</span>
              <p style="font-size:11px;color:var(--texto-suave);margin:0;">Escolha até 2 sabores</p>
            </div>
          </div>
          <div>
      ...
      <div class="col-md-6">
        <div class="guia-card">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;flex-wrap:wrap;gap:8px;">
            ...
            <div>
              <span style="font-size:1.3rem;font-weight:700;color:var(--destaque-texto);">R$ 130,00/kg</span>
              <p style="font-size:11px;color:var(--texto-suave);margin:0;">Ingredientes selecionados</p>
            </div>
          </div>
          <div>
    ...
    <div class="guia-card" style="max-width:640px;margin:0 auto 50px;">
      ...
      <ul style="font-size:14px;color:var(--texto-suave);padding-left:18px;margin:0;">
    ...
    <div class="text-center">
      <p style="color:var(--texto-suave);font-size:14px;margin-bottom:16px;">Pronto para montar seu pedido?</p>
