...
-- 4. Conta inicial da administradora (email: admin@thayarapolizel.com, senha: admin123 - trocar depois)
...
-- 5. Criação da Tabela de Configurações
